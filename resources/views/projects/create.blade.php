                        ...
                        <form method="POST" action="{{ route('projects.store') }}" id="myForm">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" id="appName" name="appName" class="form-control @error('appName') is-invalid @enderror" value="{{ old('appName') }}" placeholder="Input your application name">
