        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="{{ url ('functions')}}"><button class="btn btn-secondary "><i class="fas fa-arrow-circle-left"></i> Back</button></a>
            </div>
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <textarea name="funcNotes" id="funcNotes" class="form-control" readonly="">{{ $func->function_FE_Duration }}</textarea>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <div class="col-sm-9">
                  <div class="card-footer text-right">
                    <a href="{{ route('functions.edit', $func->id) }}"><button class="btn btn-success "> <i class="fas fa-edit" style="font-size: 18px"></i> Edit</button></a>
                  </div>
                </div>
              </div>
            </div>
