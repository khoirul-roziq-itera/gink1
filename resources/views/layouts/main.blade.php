                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="nav-item dropdown {{ Request::is('modules/create') || Request::is('modules') || Request::is('modules/archive') ? 'active' : '' }}">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="{{ Request::is('modules') ? 'active' : '' }}"><a href="{{ url('modules') }}" style="font-weight:bold; font-size:15px"><i class="fas fa-list-ul"></i>List</a></li>
                            ...
                            <li class="{{ Request::is('admin') ? 'active' : '' }}">
                                <a href="{{ url('/admins') }}"><i class="fas fa-users fa-lg"></i><span style="font-weight:bold; font-size:19px">Data Admin</span></a>
                            </li>
                            @endif
                        </ul>
                    </div>
