...
class CreateApplicationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applications', function (Blueprint $table) {
            ...
            $table->decimal('app_FE_Cost', 15, 2);
            $table->decimal('app_FE_Price', 15, 2);
            $table->decimal('app_BE_Cost', 15, 2);
            $table->decimal('app_BE_Price', 15, 2);
            $table->decimal('app_FS_Cost', 15, 2);
            $table->decimal('app_FS_Price', 15, 2);
